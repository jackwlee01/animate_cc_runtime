...
class SceneDom extends Scene_1.Scene {
    constructor(elemId) {
        super();
        this.draw = (item, frame, lerp, callback) => {
            ...
            else if (item instanceof Frame_1.Frame) {
            ...
            else if (item instanceof SpriteInstance_1.SpriteInstance) {
            ...
            else if (item instanceof ClipInstance_1.ClipInstance) {
