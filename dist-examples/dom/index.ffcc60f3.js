...
})({"2mEg4":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c8b11d43ffcc60f3";
...
},{}],"dZpAy":[function(require,module,exports) {
var _sceneDom = require("animcc/SceneDom");
// Set up animation context and animation libraries
const scene = new _sceneDom.SceneDom('anim');
...
btnPause.onclick = ()=>{
    ...
    let gunInput1 = document.getElementById("gun-input");
    if (gunInput1) gunInput1.focus();
};
btnSwap.onclick = ()=>{
    swap = !swap;
};
...
function drawWithLogic(item, frame1, lerp) {
    if (swap && item.name == "Shell") scene.current.appendChild(shellInput);
    else if (swap && item.name == "stardude_assets/StarGuyGun") scene.current.appendChild(gunInput);
    else item.draw(frame1, lerp, drawWithLogic);
}
function update() {
    if (play) {
        scene.clear();
...
},{"animcc/SceneDom":"2Eu4N"}],"2Eu4N":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SceneDom", ()=>SceneDom
);
...
class SceneDom extends _scene.Scene {
    constructor(elemId){
        super();
        this.draw = (item, frame, lerp, callback)=>{
            ...
            if (item instanceof _layer.Layer) {
                ...
                this.pop();
            } else if (item instanceof _frame.Frame) {
                this.pushElem('frame', item.name, item.id);
                if (callback) callback(item, frame, lerp);
                else item.draw(frame, lerp, callback);
                this.pop();
            } else if (item instanceof _spriteInstance.SpriteInstance) {
                this.pushElem('sprite', item.name, item.id);
                this.transformInstance(item, frame, lerp);
                if (callback) callback(item, frame, lerp);
                else item.draw(frame, lerp, callback);
                this.pop();
            } else if (item instanceof _clipInstance.ClipInstance) {
...
},{"./Layer":"7pPtx","./Scene":"3E7xP","./ClipInstance":"lcRZo","./Frame":"1vPWB","./Sprite":"g3GJM","./SpriteInstance":"JuFoS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7pPtx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./Drawable":"7D6fr","./Frame":"1vPWB","./util/math":"cxIXW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7D6fr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"1vPWB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./Instance":"7I8vs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3E7xP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./Drawable":"7D6fr","./Layer":"7pPtx","./util/math":"cxIXW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g3GJM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2mEg4","dZpAy"], "dZpAy", "parcelRequire5443")

//# sourceMappingURL=index.ffcc60f3.js.map
